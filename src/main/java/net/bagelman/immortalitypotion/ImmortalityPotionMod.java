package net.bagelman.immortalitypotion;
...
import net.bagelman.immortalitypotion.init.ImmortalityPotionModPotions;
import net.bagelman.immortalitypotion.init.ImmortalityPotionModMobEffects;
...
@Mod("immortality_potion")
public class ImmortalityPotionMod {
	public static final Logger LOGGER = LogManager.getLogger(ImmortalityPotionMod.class);
	public static final String MODID = "immortality_potion";

	public ImmortalityPotionMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		ImmortalityPotionModPotions.REGISTRY.register(modEventBus);
		ImmortalityPotionModMobEffects.REGISTRY.register(modEventBus);
